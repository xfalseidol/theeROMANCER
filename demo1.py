from supervisor import SingleThreadSupervisor
...
# This minimal demo contains just a couple of items, the full disposition tree isn't essential, so we can use the DispositionStump instead
